-- slightly modified from the original beam.lua
...
-- beam search options
-- Yonatan: modified default beam to be 1 because we don't use beam here
cmd:option('-beam', 1,[[Beam size]])
cmd:option('-max_sent_l', 500, [[Maximum sentence length. If any sequences in srcfile are longer than this then it will error out]])
...
-- paths
cmd:option('-cl_train_lbl_file', '', 'Path to train file with labels')
cmd:option('-cl_val_lbl_file', '', 'Path to validation file with labels')
cmd:option('-cl_test_lbl_file', '', 'Path to test file with labels')
cmd:option('-cl_train_source_file', '', 'Path to train file with source sentences')
cmd:option('-cl_val_source_file', '', 'Path to validation file with source sentences')
cmd:option('-cl_test_source_file', '', 'Path to test file with source sentences')
...
cmd:option('-cl_batch_size', 16, 'Classifier batch size')
cmd:option('-cl_epochs', 30, 'Maximum number of epochs for training the classifier')
cmd:option('-cl_max_sent_len', 50, 'Maximum sentence length')
